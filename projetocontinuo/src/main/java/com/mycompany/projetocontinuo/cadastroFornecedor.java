...
public class cadastroFornecedor extends javax.swing.JFrame {
    ...
    private void botaoConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoConsultarActionPerformed
        ...
        try {
            sql = "select * from fornecedores where email = '" + campoEmail.getText() + "'";
            ...
            campoID.setText(rs.getString("idFornecedor"));
    ...
    private void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExcluirActionPerformed
        ...
        try {
            ...
            if (opcaoExclusao == 0){
                sql = "DELETE FROM fornecedores where idFornecedor =" + campoID.getText();
    ...
    private void botaoAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAlterarActionPerformed
        ...
        try {
            sql = "update fornecedores set nome = '" + campoNome.getText() + "'," + "email = '" + campoEmail.getText() + "'," + "telefone = '" + campoTelefone.getText() +
            "'," + "cnpj = '" + campoCNPJ.getText() +
            "'," + "endereco = '" + campoEndereco.getText() + "'," + "bairro = '" + campoBairro.getText() + "'," + "complemento = '" + campoComplemento.getText() + "'," +
            "cep = '" + campoCEP.getText() + "' where idFornecedor = " + campoID.getText();
            Statement stm = con.prepareStatement(sql);
            stm.execute(sql);
    ...
    private void botaoCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoCadastrarActionPerformed
        ...
        try {
            ...
            || (campoEndereco.getText().equals("")) || (campoBairro.getText().equals("")) || (campoComplemento.getText().equals("")) || (campoCEP.getText().equals(""))){
                ...
                sql = "insert into fornecedores (nome, email, telefone, cnpj, endereco, bairro, complemento, cep)"+
