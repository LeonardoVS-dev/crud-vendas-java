...
public class cadastroTransportadora extends javax.swing.JFrame {
    ...
    /**
     * Creates new form cadastroTransportadora
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gerenciamento de transportadores");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(campoCNPJ, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(campoCEP, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE))))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(campoComplemento, javax.swing.GroupLayout.DEFAULT_SIZE, 33, Short.MAX_VALUE)
    ...
    private void botaoConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoConsultarActionPerformed
        ...
        try {
            sql = "select * from transportadores where email = '" + campoEmail.getText() + "'";
            ...
            campoID.setText(rs.getString("idTransportador"));
    ...
    private void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExcluirActionPerformed
        ...
        try {
            ...
            if (opcaoExclusao == 0){
                sql = "DELETE FROM transportadores where idTransportador =" + campoID.getText();
    ...
    private void botaoAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAlterarActionPerformed
        ...
        try {
            sql = "update transportadores set nome = '" + campoNome.getText() + "'," + "email = '" + campoEmail.getText() + "'," + "telefone = '" + campoTelefone.getText() +
            "'," + "cnpj = '" + campoCNPJ.getText() +
            "'," + "endereco = '" + campoEndereco.getText() + "'," + "bairro = '" + campoBairro.getText() + "'," + "complemento = '" + campoComplemento.getText() + "'," +
            "cep = '" + campoCEP.getText() + "' where idTransportador = " + campoID.getText();
            Statement stm = con.prepareStatement(sql);
            stm.execute(sql);
    ...
    private void botaoCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoCadastrarActionPerformed
        ...
        try {
            if ((campoEmail.getText().equals("")) || (campoNome.getText().equals("")) || (campoTelefone.getText().equals("")) || (campoCNPJ.getText().equals(""))
                ...
                sql = "insert into transportadores (nome, email, telefone, cnpj, endereco, bairro, complemento, cep)"+
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cadastroTransportadora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
